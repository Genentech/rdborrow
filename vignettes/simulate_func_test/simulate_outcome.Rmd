...
Here, besides the aforementioned setup, we further consider two more additional followup time points. At these two later time points, all the participants in the internal group are switched to treated group $A = 1$. The outcome models are still linear but with time-varying parameters.
...
outcome_model_specs <- list(
  ...
  list(effect = 0, model_form_x = model_form_x_t2,
    noise_mean = 0, noise_sd = 0.5),
  list(effect = 5, model_form_x = model_form_x_t3,
    noise_mean = 0, noise_sd = 0.5),
  list(effect = 5, model_form_x = model_form_x_t4,
    noise_mean = 0, noise_sd = 0.5)
)
