...
#' @param p Positive integer. Number of covariates. Must equal the dimension
#'   of `cp`.
...
#' @param paramMargins List of length `p`. Each element is a named list of
#'   parameters for the corresponding marginal distribution.
#'
#' @return A data frame with `n` rows and `p` columns named `x1`, ..., `xp`.
#' @export
#'
#' @examples
